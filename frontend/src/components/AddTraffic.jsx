  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-2">
      <div className="bg-white p-4 rounded-md shadow-md max-w-sm w-full">
        <h1 className="text-xl font-bold mb-4 text-center">Add Traffic Police</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center flex-col gap-2 justify-between">
            ...
            <button type="button" className="bg-red-500 px-4 py-1 rounded-md hover:bg-red-600 transition-colors" onClick={() => setAddTraffic(false)}>
              Cancel
            </button>
          </div>
        </form>
